...
namespace Gymunity.Admin.MVC.Services
{
    ...
    /// </summary>
    public class AdminUserResolverService(UserManager<AppUser> userManager, ILogger<AdminUserResolverService> logger) : IAdminUserResolverService
    {
        private readonly UserManager<AppUser> _userManager = userManager;
        private readonly ILogger<AdminUserResolverService> _logger = logger;
